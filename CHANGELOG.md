...
- Warn and keep the configured Kueue priority if `priority_source_job` cannot be
  read or has no priority label; stop waiting for the lookup after five seconds.
